...
export const ChatPanel: React.FC<ChatPanelProps> = ({ designId: _ }) => {
                  ...
                  <div className="mt-2 space-y-1">
                    {message.suggestions.map((suggestion, index) => (
                      <button
                        ...
                        className="block w-full text-left text-xs bg-white/30 hover:bg-white/50 backdrop-blur-sm border border-white/20 rounded-lg px-2 py-1 text-gray-700 transition-all"
                      >
                        {suggestion}
                      </button>
                    ))}
